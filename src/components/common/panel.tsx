...
const Panel: React.FC<IPanel> = ({
    ...
    return (
        ...
        <div className="row" >
            <motion.div
                    className="col-12 col-md-10 col-lg-5 mx-auto position-relative home-panel d-flex flex-col justify-content-end"
    animate = {{
    ...
    <div className="m-0 p-0 w-100 menu-chains " > </div>
        < div className = "m-0 p-0 menu-board-wrapper w-100 d-flex justify-content-end" >
            <div className="h-100 w-100 d-flex flex-column justify-content-end text-white p-0 mt-auto" >
                <img src={ menuBoard } className = "board-menu" alt = "" />

                    <div className="menu-text w-100 " >
                        <div className="mx-5" >
                            {(window.location.pathname === "/")
                            ? <h1 className="size-60" > { title } </h1>
                                        : <h1 className="size-60 color-red" > { title } </h1>}
{ descrip }
