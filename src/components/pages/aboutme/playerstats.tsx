            ...
            <div className="row">
                ...
                <div className="col-12 col-lg-8">
                    <div className="orange-panel size-30 text-white text-left">
                        ...
                        {leetcodeLink && (
                            <p>
                                <span className="color-cyan">leetcode:</span>{' '}
                                <a href={leetcodeLink} target="_blank" rel="noreferrer" className="text-white">
                                    {leetcodeLink.replace(/^https?:\/\//, '')}
                                </a>
                            </p>
                        )}
                    </div>
